...
This feature is available in Azure SQL Managed Instance with the [Always-up-to-date update policy](azure/azure-sql/managed-instance/update-policy?view=azuresql&tabs=azure-portal#always-up-to-date-update-policy) configured.
